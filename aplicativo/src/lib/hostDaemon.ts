...
const DEFAULT_LAN_WIDTH = 640;
const DEFAULT_LAN_HEIGHT = 360;
const DEFAULT_LAN_FPS = 20;
const DEFAULT_LAN_BITRATE_KBPS = 1200;
const DEFAULT_LAN_MIN_BITRATE_KBPS = 350;
const DEFAULT_LAN_KEYFRAME_INTERVAL = 20;
const DEFAULT_LAN_BITRATE_STEP_PCT = 0.7;
const DEFAULT_LAN_MAX_PAYLOAD_BYTES = 1050;
